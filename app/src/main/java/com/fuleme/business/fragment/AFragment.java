...
public class AFragment extends Fragment {
    ...
    private int[] mImageDatas = {R.mipmap.icon_n_5, R.mipmap.icon_n_6, R.mipmap.icon_n_7, R.mipmap.icon_n_9, R.mipmap.icon36, R.mipmap.icon_pinjia, R.mipmap.icon_n_10};
    private String[] mTextDatas = {"商家活动", "官方活动", "会员管理", "积分商城", "汇总查询", "顾客评价", "供应链"};
    private String[] mTextContentDatas = {"每天帮我做促销", "每天帮我做促销", "每天帮我做促销", "每天帮我做促销", "每天帮我做促销", "每天帮我做促销", "每天帮我做促销"};
        ...
        mAdapter.setOnItemClickListener(new AFragmentAdapter.onRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View v, String itemText) {
                ...
                if (mTextDatas[0].equals(itemText)) {
                    ...
                    //顾客评价
                    ToastUtil.showMessage("新功能正在开发");
                } else if (mTextDatas[6].equals(itemText)) {
                    //供应链
                    ToastUtil.showMessage("新功能正在开发");
                }
            }
    ...
    public void initConvenientBanner() {
        ...
        mConvenientBanner.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                WebActivity.url = "https://www.baidu.com";
