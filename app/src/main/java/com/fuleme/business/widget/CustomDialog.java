...
public class CustomDialog extends Dialog {
    ...
    public static class Builder {
        ...
        private int lImageId = 0;
        private int rImageId = 0;
        ...
        public Builder showTitleImageL(int lImageId) {
            this.lImageId = lImageId;
            return this;
        }

        public Builder showTitleImageR(int rImageId) {
        ...
        public CustomDialog create() {
            ...
            if (lImageId != 0) {
                ((ImageView) layout.findViewById(R.id.iv_left)).setImageResource(lImageId);
            } else {
                layout.findViewById(R.id.iv_left).setVisibility(View.GONE);
            }
            if (rImageId != 0) {
                ((ImageView) layout.findViewById(R.id.iv_r)).setImageResource(rImageId);
            } else {
